...
public class NewlectMemberDao extends JdbcDaoSupport implements MemberDao{
	public Member getMember(String uid) throws ClassNotFoundException, SQLException
	{
		String sql = "SELECT * FROM MEMBER WHERE \"UID\"=?";
		return getJdbcTemplate().queryForObject(sql, 
				new BeanPropertyRowMapper<Member>(Member.class), uid);
	...
	public int insert(Member member) throws ClassNotFoundException, SQLException
	{
		...
		//:명명자는 VO에서 만들어둔 변수명과 반드시 일치하여야 한다! (대소문자 구분)
